...
const settings = {
  dimensions: [ 2160, 2160 ], //2 times insta
...
const sketch = () => {
  return ({ context, width, height }) => {
    ...
    // const Austria= {'Happy' :  9, 'Land' :  6, 'Age' :  9, 'Population' :  6, 'Urban' :  5}
    // const Belgium= {'Happy' :  7, 'Land' :  2, 'Age' :  6, 'Population' :  8, 'Urban' :  10}
    // const Bulgaria= {'Happy' :  0, 'Land' :  7, 'Age' :  10, 'Population' :  5, 'Urban' :  8}
    // const Cyprus= {'Happy' :  3, 'Land' :  1, 'Age' :  0, 'Population' :  1, 'Urban' :  1}
    // const Czechia= {'Happy' :  7, 'Land' :  5, 'Age' :  3, 'Population' :  7, 'Urban' :  6}
    // const Germany= {'Happy' :  8, 'Land' :  9, 'Age' :  10, 'Population' :  10, 'Urban' :  9}
    // const Denmark= {'Happy' :  10, 'Land' :  3, 'Age' :  6, 'Population' :  5, 'Urban' :  2}
    // const Spain= {'Happy' :  6, 'Land' :  10, 'Age' :  6, 'Population' :  9, 'Urban' :  9}
    // const Estonia= {'Happy' :  2, 'Land' :  3, 'Age' :  5, 'Population' :  2, 'Urban' :  7}
    // const Finland= {'Happy' :  10, 'Land' :  9, 'Age' :  8, 'Population' :  4, 'Urban' :  7}
    // const France= {'Happy' :  6, 'Land' :  10, 'Age' :  4, 'Population' :  10, 'Urban' :  9}
    // const Greece= {'Happy' :  1, 'Land' :  7, 'Age' :  9, 'Population' :  7, 'Urban' :  8}
    // const Croatia= {'Happy' :  1, 'Land' :  6, 'Age' :  9, 'Population' :  3, 'Urban' :  2}
    // const Hungary= {'Happy' :  2, 'Land' :  7, 'Age' :  4, 'Population' :  6, 'Urban' :  7}
    // const Ireland= {'Happy' :  8, 'Land' :  5, 'Age' :  1, 'Population' :  4, 'Urban' :  4}
    // const Italy= {'Happy' :  6, 'Land' :  8, 'Age' :  10, 'Population' :  10, 'Urban' :  10}
    // const Lithuania= {'Happy' :  4, 'Land' :  4, 'Age' :  3, 'Population' :  3, 'Urban' :  5}
    // const Luxembourg= {'Happy' :  9, 'Land' :  1, 'Age' :  2, 'Population' :  1, 'Urban' :  0}
    // const Latvia= {'Happy' :  3, 'Land' :  4, 'Age' :  7, 'Population' :  2, 'Urban' :  6}
    // const Malta= {'Happy' :  7, 'Land' :  0, 'Age' :  4, 'Population' :  0, 'Urban' :  10}
    // const Netherlands= {'Happy' :  10, 'Land' :  2, 'Age' :  7, 'Population' :  8, 'Urban' :  6}
    // const Poland= {'Happy' :  5, 'Land' :  9, 'Age' :  2, 'Population' :  9, 'Urban' :  4}
    // const Portugal= {'Happy' :  2, 'Land' :  6, 'Age' :  7, 'Population' :  6, 'Urban' :  4}
    // const Romania= {'Happy' :  4, 'Land' :  8, 'Age' :  3, 'Population' :  9, 'Urban' :  3}
    // const Slovakia= {'Happy' :  5, 'Land' :  4, 'Age' :  1, 'Population' :  4, 'Urban' :  2}
    // const Slovenia= {'Happy' :  4, 'Land' :  2, 'Age' :  8, 'Population' :  2, 'Urban' :  3}
    // const Sweden= {'Happy' :  9, 'Land' :  10, 'Age' :  5, 'Population' :  7, 'Urban' :  1}


// creation indicator list to be able to loop
const indicator_list = ["Happy","Land", "Age", "Population", "Urban"];
const indicator =  indicator_list[Math.floor(Math.random()*indicator_list.length)];//params.indic
console.log("indicator", indicator)


const degToRad = (degrees) => {
  return degrees * Math.PI; //f_pop 1 DEFINITION DENTELLE. 1 TO 360
};
...
const radius = width * scaleLand // from 0.1 to 1
...
for (let i =0; i <scalePop; i++){
  ...
  x = cx + radius * Math.sin(angle / Math.PI +7);

...
const params= {
   score: 3, //set default value in the pane
   indic: "CO2", //set default value in the pane
}
...
const sketch = () => {
  return ({ context, width, height }) => {
    ...
    const indicator_list = ["avg","CO2", "GDP", "Happy", "Land", "Pop"];
  ...
  context.fillText("Europe ", 760, 1000);
...
const createPane = () => {
  ...
  folder.addInput(params, "indic", { options : { avg : "avg", CO2 : "CO2", Land: "Land", Pop: "Pop", Happy: "Happy"}});
...
//   context.fillStyle = "#2D3F3C";
//   context.font = "60px futura";
//   context.fillText(indicator, x_center-80, 1000);
//   // context.shadowBlur = 60;
//   context.restore()
//     };
//   };
